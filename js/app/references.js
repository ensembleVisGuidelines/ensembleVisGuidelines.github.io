define(['jquery', 'app/bib'], function ($, bib) {
    ...
    var fields = ['author', 'title', 'booktitle', 'publisher', 'pages', 'year', 'doi', 'location', 'address', 'editors', 'series', 'journal', 'institution', 'volume', 'number', 'guideline_acc', 'guideline_time', 'guideline_user'];
